import{J as m,c as x,p as u,t as g,s as p,a as d,b as c,e as i,f,h as w,r as s,i as y,m as T,j as E,g as h}from"./custom-element.js";import{a as S}from"./css.js";import{i as P}from"./if.js";import{s as D}from"./class.js";import{p as H}from"./props.js";import"./attributes.js";function M(r){m(window,["online","offline"],()=>{r(navigator.onLine)})}var L=g('<span class="status-text svelte-1982ne4"> </span>'),G=g('<span><span class="status-dot svelte-1982ne4"></span> <!></span>');const O={hash:"svelte-1982ne4",code:`
  /* 1. Importiere Fluid Tokens & Styles */
  /* =========================================================
...
*/:root[data-theme="tron"] {
  ...
  /* ---------------------------------------------------------
   1) BASE STYLES
   --------------------------------------------------------- */.svelte-1982ne4,
.svelte-1982ne4::before,
.svelte-1982ne4::after {box-sizing:border-box;}
  @starting-style {
}
  /* --- Breadcrumbs --- */
  /* =========================================================
 ...
 */
  ...
  /* --- Basis Badge Style --- */.rz-badge.svelte-1982ne4 {display:inline-flex;align-items:center;justify-content:center;gap:0.4rem; /* Abstand Dot <-> Text */padding:0.25rem 0.65rem; /* Pill Padding */border-radius:var(--radius-pill);border:1px solid transparent;font-family:var(--font-family-sans);font-size:0.85rem;font-weight:var(--font-weight-medium);line-height:1;transition:all 0.3s ease;}
  /* Wenn kein Text da ist, machen wir das Badge rund (nur der Dot) */
  /* Optional: Du kannst dies entfernen, wenn es auch ohne Text eine Pille bleiben soll */
  /* .rz-badge:not(:has(.status-text)) {
    padding: 0.4rem;
    border-radius: 50%;
  } */
  /* --- Status: ONLINE (Success Green) --- */
  /* Wir nutzen OKLCH Werte passend zu deinen "Success/Emerald" Tokens */.is-online.svelte-1982ne4 {background-color:oklch(0.96 0.04 150); /* Sehr helles Grün */color:oklch(0.4 0.1 150);              /* Dunkles Grün für Text */border-color:oklch(0.85 0.1 150);      /* Rahmen */box-shadow:0 1px 2px oklch(0.85 0.1 150 / 0.3);}
  /* --- Status: OFFLINE (Critical Red) --- */
  /* Passend zu deinen "Critical/Berry" Tokens */.is-offline.svelte-1982ne4 {background-color:oklch(0.96 0.04 30); /* Sehr helles Rot */color:oklch(0.45 0.15 30);            /* Dunkles Rot */border-color:oklch(0.85 0.1 30);opacity:0.8; /* Offline etwas ausgegraut wirken lassen */}
  /* --- Der Dot --- */.status-dot.svelte-1982ne4 {height:8px;width:8px;border-radius:50%;background-color:currentColor; /* Erbt die Textfarbe (Dunkelgrün/Rot) */flex-shrink:0;}
  /* Puls-Effekt nur wenn Online */.is-online.svelte-1982ne4 .status-dot:where(.svelte-1982ne4) {box-shadow:0 0 0 rgba(0, 255, 0, 0.4);
    animation: svelte-1982ne4-pulse 2s infinite;}
  /* --- Dark Mode Support (via Tokens) --- */
  /* Da wir OKLCH hardcoded haben für semantische Farben, 
     müssen wir für Dark Mode evtl. abdunkeln, falls der Hintergrund dunkel ist.
     Hier nutzen wir :host-context oder Media Query Strategie, 
     aber Fluid Tokens regeln das meiste. 
     Für semantische Badges auf dunklem Grund passen wir die Helligkeit an: 
  */
  @media (prefers-color-scheme: dark) {.is-online.svelte-1982ne4 {background-color:oklch(0.2 0.1 150 / 0.3); /* Dunkles transparentes Grün */color:oklch(0.8 0.15 150);                 /* Helles Neon-Grün */border-color:oklch(0.4 0.15 150);}.is-offline.svelte-1982ne4 {background-color:oklch(0.2 0.1 30 / 0.3);color:oklch(0.8 0.15 30);border-color:oklch(0.4 0.15 30);}
  }
  /* Keyframes für den Puls */
  @keyframes svelte-1982ne4-pulse {
    0% {
      box-shadow: 0 0 0 0 oklch(0.65 0.15 150 / 0.4);
    }
    70% {
      box-shadow: 0 0 0 4px oklch(0.65 0.15 150 / 0);
    }
    100% {
      box-shadow: 0 0 0 0 oklch(0.65 0.15 150 / 0);
    }
  }`};function C(r,n){u(n,!1),S(r,O);let t=T(!0),a=H(n,"with_text",12,"no");var e=G(),k=p(d(e),2);{var b=o=>{var l=L(),v=d(l,!0);s(l),c(()=>E(v,h(t)?"Online":"Offline")),i(o,l)};P(k,o=>{a()==="yes"&&o(b)})}return s(e),c(()=>D(e,1,`rz-badge ${h(t)?"is-online":"is-offline"}`,"svelte-1982ne4")),M(o=>y(t,o)),i(r,e),f({get with_text(){return a()},set with_text(o){a(o),w()}})}customElements.define("rz-online",x(C,{with_text:{}},[],[],!0));
